...
router.get('/:id', authenticate(), async (req, res, next) => {
	...
	res.locals.xmlContainer = ['entidade', 'tipologias', 'tipologia', 'intervencoesComoDono', 'intervencaoComoDono', 'intervencoesComoParticipante', 'intervencaoComoParticipante']
